...
export const ResumeBuilderPage = () => {
  ...
  const generateSummary = async () => {
    try {
      ...
      const response = await fetch("/api/resume/ai/generate-summary", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          name: data.name,
  ...
  const improveProjectDescription = async (projectIdx) => {
    try {
      ...
      const improveRes = await fetch("/api/resume/ai/improve-project", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  const generateAchievements = async (expIdx) => {
    try {
      ...
      const achieveRes = await fetch("/api/resume/ai/generate-achievements", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          role: exp.role,
